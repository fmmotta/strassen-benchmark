...
//NOTE TO SELF:
//Preciso rever a implementacao de strassen para nao usar vector.
//Se usar vector<float> vai ter problema para chamar a blas quando a dimensao 
//for menor que blas_boundary.

// size to start using BLAS 
int blas_boundary;

//Function Protos
void strassen( float &A, 
               float &B, 
               float &C,
               unsigned int dim);

void sgemm( char *trans_a,
            char *trans_b,
            int *m,
            int *n,
            int *k,
